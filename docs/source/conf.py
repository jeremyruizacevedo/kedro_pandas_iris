...
# kedro_pandas_iris documentation build
...
from kedro_pandas_iris import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_pandas_iris"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_pandas_irisdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_pandas_iris.tex",
        "kedro_pandas_iris Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_pandas_iris",
        "Project kedro_pandas_iris codebase.",
        "Data-Science",
    )
]
